...
const TypographyFont = ['poppins'] as const;
    ...
    return (
      <Component
        ...
        className={clsxm(
          //#region  //*=========== Variants ===========
          [
            variant === 'j1' && ['font-poppins text-4xl font-bold'],
            variant === 'j2' && ['font-poppins text-3xl font-bold'],
            variant === 'h1' && ['font-poppins text-2xl font-semibold'],
            variant === 'h2' && ['font-poppins text-xl font-semibold'],
            variant === 'h3' && ['font-poppins text-lg font-semibold'],
            variant === 'h4' && ['font-poppins text-base font-bold'],
            variant === 'h5' && ['font-poppins text-base font-semibold'],
            variant === 'h6' && ['font-poppins text-sm font-semibold'],
